...
h_eps=0.030 # opls -> 0.030 | 2e-3
pair_coef=np.array([
[[(0.066*0.066)**.5*4*ljfct*ff_scale, (3.500*3.500)**.5, lj8,lj10,lj12, (0.145*0.145)*332.06371*ff_scale]],
[[(0.066*h_eps)**.5*4*ljfct*ff_scale, (3.500*2.500)**.5, lj8,lj10,lj12, (0.145*0.040)*332.06371*ff_scale]],
[[(0.066*0.000)**.5*4*ljfct*ff_scale, (3.500*0.000)**.5, lj8,lj10,lj12, (0.145*0.418)*332.06371*ff_scale]],
[[(0.066*0.170)**.5*4*ljfct*ff_scale, (3.500*3.120)**.5, lj8,lj10,lj12, (0.145*-.683)*332.06371*ff_scale]],
[[(h_eps*h_eps)**.5*4*ljfct*ff_scale, (2.500*2.500)**.5, lj8,lj10,lj12, (0.040*0.040)*332.06371*ff_scale]],
[[(h_eps*0.000)**.5*4*ljfct*ff_scale, (2.500*0.000)**.5, lj8,lj10,lj12, (0.040*0.418)*332.06371*ff_scale]],
[[(h_eps*0.170)**.5*4*ljfct*ff_scale, (2.500*3.120)**.5, lj8,lj10,lj12, (0.040*-.683)*332.06371*ff_scale]],
[[(0.000*0.000)**.5*4*ljfct*ff_scale, (0.000*0.000)**.5, lj8,lj10,lj12, (0.418*0.418)*332.06371*ff_scale]],
[[(0.000*0.170)**.5*4*ljfct*ff_scale, (0.000*3.120)**.5, lj8,lj10,lj12, (0.418*-.683)*332.06371*ff_scale]],
[[(0.170*0.170)**.5*4*ljfct*ff_scale, (3.120*3.120)**.5, lj8,lj10,lj12, (-.683*-.683)*332.06371*ff_scale]],
])*np.array([[[1,1,1,1,1,1],[0,.4,1,1,1,0],[0,.4,1,1,1,0],[.5,1,1,1,1,.5]]])
...
[(0.225- 0)*ff_scale_i, (0 - 3*0.225)*ff_scale_i, (0*2)*ff_scale_i, (0.225*4)*ff_scale_i],
])

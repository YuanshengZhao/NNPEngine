...
pair_coef=np.array([
[[(0.066*0.066)**.5*4*ljfct*ff_scale, (3.50*3.50)**.5, lj8,lj10,lj12, (-.180*-.180)*332.06371*ff_scale]],
[[(0.066*0.066)**.5*4*ljfct*ff_scale, (3.50*3.50)**.5, lj8,lj10,lj12, (-.180*0.145)*332.06371*ff_scale]],
[[(0.066*h_eps)**.5*4*ljfct*ff_scale, (3.50*2.50)**.5, lj8,lj10,lj12, (-.180*0.060)*332.06371*ff_scale]],
[[(0.066*0.000)**.5*4*ljfct*ff_scale, (3.50*0.00)**.5, lj8,lj10,lj12, (-.180*0.418)*332.06371*ff_scale]],
[[(0.066*0.170)**.5*4*ljfct*ff_scale, (3.50*3.12)**.5, lj8,lj10,lj12, (-.180*-.683)*332.06371*ff_scale]],
...
[[(0.000*0.170)**.5*4*ljfct*ff_scale, (0.00*0.00)**.5, lj8,lj10,lj12, (0.418*0.418)*332.06371*ff_scale]],

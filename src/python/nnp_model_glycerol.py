...
cfd=np.random.uniform(-20,0,size=(NUM_PAIR,4,NUM_DESC))
cfr=np.random.uniform( 0,5,size=(NUM_PAIR,4,NUM_DESC))
pair_coef=np.array([
[[(0.0660*0.0660)**.5*4, (3.50*3.50)**.5, 0,0,1, (0.205*0.205)*332.06371]],
[[(0.0660*0.0660)**.5*4, (3.50*3.50)**.5, 0,0,1, (0.205*0.145)*332.06371]],
[[(0.0660*0.0300)**.5*4, (3.50*2.50)**.5, 0,0,1, (0.205*0.060)*332.06371]],
[[(0.0660*0.0000)**.5*4, (3.50*0.00)**.5, 0,0,1, (0.205*0.418)*332.06371]],
[[(0.0660*0.1700)**.5*4, (3.50*3.12)**.5, 0,0,1, (0.205*-.683)*332.06371]],
[[(0.0660*0.0660)**.5*4, (3.50*3.50)**.5, 0,0,1, (0.145*0.145)*332.06371]],
[[(0.0660*0.0300)**.5*4, (3.50*2.50)**.5, 0,0,1, (0.145*0.060)*332.06371]],
[[(0.0660*0.0000)**.5*4, (3.50*0.00)**.5, 0,0,1, (0.145*0.418)*332.06371]],
[[(0.0660*0.1700)**.5*4, (3.50*3.12)**.5, 0,0,1, (0.145*-.683)*332.06371]],
[[(0.0300*0.0300)**.5*4, (2.50*2.50)**.5, 0,0,1, (0.060*0.060)*332.06371]],
[[(0.0300*0.0000)**.5*4, (2.50*0.00)**.5, 0,0,1, (0.060*0.418)*332.06371]],
[[(0.0300*0.1700)**.5*4, (2.50*3.12)**.5, 0,0,1, (0.060*-.683)*332.06371]],
[[(0.0000*0.0000)**.5*4, (0.00*0.00)**.5, 0,0,1, (0.418*0.418)*332.06371]],
[[(0.0000*0.1700)**.5*4, (0.00*3.12)**.5, 0,0,1, (0.418*-.683)*332.06371]],
[[(0.1700*0.1700)**.5*4, (3.12*3.12)**.5, 0,0,1, (-.683*-.683)*332.06371]],
...
angle_coef=np.array([
[np.cos(112.7*np.pi/180), 44.47244792058399, 0.34951368362716256, 63.127481162547255 ],
[np.cos(109.5*np.pi/180), 31.035138693856492, 0.34056135730550974, 52.67047953244677 ],
[np.cos(110.7*np.pi/180), 25.065263841028393, 0.34531565734984593, 39.86556812703493 ],
[np.cos(108.5*np.pi/180), 32.1847926045434  , 0.33522167278748977, 57.54075148912716 ],
[np.cos(107.8*np.pi/180), 18.55869561697983, 0.3307054673345205, 34.372035317347134  ],
[np.cos(109.5*np.pi/180), 31.035138693856492, 0.34056135730550974, 52.67047953244677 ],
])
dihedral_coef=np.array([
[0.1556 - 0, 0 - 3*0.1556, 0*2, 0.1556*4],
[0.1556 - 0, 0 - 3*0.1556, 0*2, 0.1556*4],
[1.1440 - 1, 0 - 3*0.1440, 1*2, 0.1440*4],
[0.1556 - 0, 0 - 3*0.1556, 0*2, 0.1556*4],
[0.1667 - 0, 0 - 3*0.1667, 0*2, 0.1667*4],
[0.1667 - 0, 0 - 3*0.1667, 0*2, 0.1667*4],
[0.1556 - 0, 0 - 3*0.1556, 0*2, 0.1556*4],
])

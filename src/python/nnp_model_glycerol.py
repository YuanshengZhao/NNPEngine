...
_nf1,_nf2,_nf3=32,16,16

_x=tf.keras.layers.Input([NUM_ATOM,NUM_DESC])
_y=tf.keras.layers.LocallyConnected1D(filters=_nf1,kernel_size=1,data_format="channels_last")(_x)
_y=tf.keras.layers.Activation(sft_sign)(_y)
_y=tf.keras.layers.LocallyConnected1D(filters=_nf2,kernel_size=3,strides=2,data_format="channels_first")(_y)
_y=tf.keras.layers.Activation(sft_sign)(_y)
_y=tf.keras.layers.Flatten()(_y)
_y=tf.keras.layers.Dense(_nf3)(_y)
_y=tf.keras.layers.Activation(sft_sign)(_y)
...
pair_coef=np.array([
[[(0.066*0.066)**.5*4*ljfct*ff_scale, (3.50*3.50)**.5, lj8,lj10,lj12, (0.205*0.205)*332.06371*ff_scale]],
[[(0.066*0.066)**.5*4*ljfct*ff_scale, (3.50*3.50)**.5, lj8,lj10,lj12, (0.205*0.145)*332.06371*ff_scale]],
[[(0.066*h_eps)**.5*4*ljfct*ff_scale, (3.50*2.50)**.5, lj8,lj10,lj12, (0.205*0.060)*332.06371*ff_scale]],
[[(0.066*0.000)**.5*4*ljfct*ff_scale, (3.50*0.00)**.5, lj8,lj10,lj12, (0.205*0.418)*332.06371*ff_scale]],
[[(0.066*0.170)**.5*4*ljfct*ff_scale, (3.50*3.12)**.5, lj8,lj10,lj12, (0.205*-.683)*332.06371*ff_scale]],
...
angle_coef=np.array([
[np.cos(112.7*np.pi/180), 44.47244792058399 *ff_scale_i, 0.34951368362716256, 63.127481162547255*ff_scale_i],
